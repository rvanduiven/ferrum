...
const string strMessageMagic = "FerrumCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if (nHeight <= 1) {
        ...
        nSubsidy = 9 * COIN; // initial block reward
    }
    else if (nHeight <= 11580) {
        nSubsidy = 30 * COIN; // SUPER BLOCKS
    }
    else if (nHeight <= 18720) {
        nSubsidy = 8 * COIN; // initial block reward
    }
    else if (nHeight <= 61920) {
        nSubsidy = 7 * COIN; // initial block reward
    }
    else if (nHeight <= 148320) {
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    else if (heigth <= 11520)  {
        nSubsidy = 10 * COIN;
    }
    else if (heigth <= 18720)  {
        nSubsidy = 12 * COIN;
    }
    else if (heigth <= 28800)  {
        nSubsidy = 14 * COIN;
    }
    else if (heigth <= 38880)  {
        nSubsidy = 16 * COIN;
    }
    else if (heigth <= 48960)  {
        nSubsidy = 18 * COIN;
    }
    else if (heigth <= 69120)  {
        nSubsidy = 20 * COIN;
    }
    else{
        nSubsidy = 15 * COIN;
...
{
    RenameThread("FerrumCoin-loadblk");
